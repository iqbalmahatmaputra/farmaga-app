    ...
    <div class="col-xl-6 col-md-6 col-xs-12 mb-4">
               ...
               <div class="card border-left-primary shadow h-100 py-2">
                <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button"
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">List Order from Gudang</h6>
                </a>
                <div class="collapse show" id="collapseCardExample">
                    <div class="container mt-3">
                        <p>Silahkan tekan tombol Terima untuk memproses orderan </p>
                    </div>
                    <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".batal", function () {
            var $ele = $(this).parent().parent();
            var id = $(this).val();
            var url = "{{url('updateToAcceptCancel')}}";
            var uurl = url + "/" + id;
                ...
                success: function (dataResult) {
                    ...
                    $.each(resultData, function (index, row) {
                        ...
                        bodyData += "<td>" + i++ + "</td><td>" + row.nama_product +
                            ...
                            .id_product_order + "'>Terima</button>" +
                            "</td>";
                        bodyData += "</tr>";
